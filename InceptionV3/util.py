...
def plot_loss_accuracy(train_losses, val_losses, train_accuracies, val_accuracies, output_dir='plots'):
    ...
    # Save accuracy curve
    accuracy_plot_path = os.path.join(output_dir, 'Inceptionv3_loss_accuracy_curve.png')
...
def plot_confusion_matrix(labels, preds, class_names):
    ...
    # Save accuracy curve
    confusion_matrix_plot_path = os.path.join('plots', 'InceptionV3_confusion_matrix_curve.png')
